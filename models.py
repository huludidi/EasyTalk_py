    ...
    def searchlist(self, userinfo=None, p_board_id=None, board_id=None, orderType=None, filterType=None, pageNo=None):
        ...
        for article in articles:
            result.append({
                ...
                'p_board_id': article.p_board_id,
                'p_board_name': article.p_board_name,
                'author_id': article.author_id,
                'nick_name': article.nick_name,
                'author_school': article.author_school,
                'author_ip_address': article.author_ip_address,
                'title': article.title,
                'cover': article.cover,
                'summary': article.summary,
                'post_time': article.post_time.strftime('%Y-%m-%d %H:%M:%S'),
                'last_update_time': article.last_update_time.strftime('%Y-%m-%d %H:%M:%S'),
                'read_count': article.read_count,
                'good_count': article.good_count,
                'comment_count': article.comment_count,
                'top_type': article.top_type,
